...
export default async function handler(req, res) {
  try {
    ...
    const paymentUrl = `http://localhost:17000/cuanku?username=${encodeURIComponent(username)}&pin=${encodeURIComponent(pin)}&to=${encodeURIComponent(to)}&custom_code=${encodeURIComponent(selectedProduct.custom_code)}&idtrx=${encodeURIComponent(transactionId)}&check=1`;
